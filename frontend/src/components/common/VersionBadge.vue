  ...
  <div ref="rootRef" class="relative">
    ...
    >
      ...
      <span class="leading-[0.85rem]">
        ...
        <span class="block text-[11px] font-semibold">v{{ versionInfo?.current_version || '0.1.6' }}</span>
      </span>
          ...
          <div class="grid grid-cols-2 gap-2 text-xs">
            <div class="rounded-xl bg-gray-50 px-3 py-2 dark:bg-dark-700/50">
              ...
              <div class="mt-1 font-semibold text-gray-900 dark:text-white">
                v{{ versionInfo?.current_version || '0.1.6' }}
              </div>
            </div>
            <div class="rounded-xl bg-gray-50 px-3 py-2 dark:bg-dark-700/50">
              <div class="text-gray-500 dark:text-dark-400">最新版本</div>
              <div class="mt-1 font-semibold text-gray-900 dark:text-white">
                v{{ versionInfo?.latest_version || versionInfo?.current_version || '0.1.6' }}
              </div>
            </div>
          </div>
